...
(
    ...
    contact_fname character varying(30) COLLATE pg_catalog."default",
    contact_lname character varying(30) COLLATE pg_catalog."default",
...
(
    ...
    prod_desc character varying(100) COLLATE pg_catalog."default",
    ...
    available_size character varying(10) COLLATE pg_catalog."default" DEFAULT 'NA'::character varying,
    available_color character varying(50) COLLATE pg_catalog."default" DEFAULT 'NA'::character varying,
